...
public class WalterwhiteItem extends Item {
	...
	public WalterwhiteItem() {
		super(new Item.Properties().tab(RandomAdditionsModTabs.TAB_DELETED_MOD_ELEMENT).stacksTo(1).fireResistant().rarity(Rarity.EPIC)
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		WalterwhiteLivingEntityIsHitWithItemProcedure.execute(
