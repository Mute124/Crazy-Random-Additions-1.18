...
package net.mcreator.randomadditions.fluid.attributes;
...
public class HotfuckingwaterFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, HotfuckingwaterFluidAttributes::new);
	}
	...
	protected HotfuckingwaterFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
