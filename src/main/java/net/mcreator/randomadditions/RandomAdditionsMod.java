...
public class RandomAdditionsMod {
	...
	public RandomAdditionsMod() {
		RandomAdditionsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		RandomAdditionsModBlocks.REGISTRY.register(bus);
		RandomAdditionsModItems.REGISTRY.register(bus);
		...
		RandomAdditionsModBiomes.REGISTRY.register(bus);
