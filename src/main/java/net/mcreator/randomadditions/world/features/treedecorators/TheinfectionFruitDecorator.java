...
public class TheinfectionFruitDecorator extends CocoaDecorator {
	public static final TheinfectionFruitDecorator INSTANCE = new TheinfectionFruitDecorator();
	public static com.mojang.serialization.Codec<TheinfectionFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("theinfection_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public TheinfectionFruitDecorator() {
		super(0.2f);
	}
