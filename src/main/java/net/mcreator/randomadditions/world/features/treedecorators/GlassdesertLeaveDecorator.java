...
public class GlassdesertLeaveDecorator extends LeaveVineDecorator {
	public static final GlassdesertLeaveDecorator INSTANCE = new GlassdesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("glassdesert_tree_leave_decorator");
